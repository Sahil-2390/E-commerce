...
import {fetchAllProductsByFiltersAsync, fetchBrandAsync,fetchCategoryAsync, selectAllProducts,selectBrand,selectCategory, selecttotalItems } from '../../product.list/ProductSlice';
...
export default function AdminProduct() {
  ...
  return (
    <div className="bg-white">
      <div>
        <MobileFilter  handleFilter={handleFilter} setMobileFiltersOpen={setMobileFiltersOpen} filters={filters} mobileFiltersOpen={mobileFiltersOpen}></MobileFilter>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
             ...
             <DesktopFilter filters={filters} handleFilter={handleFilter} handleSort={handleSort}></DesktopFilter>
            ...
            <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
              <div>
                <p className="text-sm text-gray-700">
                  ...
                  <span className="font-medium">{page * ITEMS_PER_PAGE > totalItems //total items vary when filter is applied
                   ? totalItems
                   :page*ITEMS_PER_PAGE}
                   </span> of{' '}
