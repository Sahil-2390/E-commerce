...
const ProductDetails = () => {
   ...
   const handleCart=(e)=>{
    e.preventDefault();
   if (items.findIndex(item=>item.product.id===product.id)){
    const newItem={product:product.id, 
      quantity:1}
      ...
      {product && (<div className="pt-6">
        ...
        <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <p className="text-3xl line-through tracking-tight text-gray-900">Rs{product.price}</p>
            <p className="text-3xl tracking-tight text-gray-900">Rs{discountedPrice(product)}</p>
